...
C
C  נ/נ נEPECשלKי üלEMEHOB BEKTOPA-PEûEHיס BHץTPי CAMOחO
C  BEKTOPA-PEûEHיס הלס נPיBEהEHיס HץMEPAדיי ץתלOB
...
C  BEKTOPOM OTOגPAצEHיס  NOUZ    /CM. נ/נ SORTUZ/
      TERM=NOUZ(I)
   10 UT(TERM)=U(I)
C  TEנEPר נEPEניûEM ית CץצEגHOחO BEKTOPA UT
C  B BEKTOP PEûEHיס U:
      DO 15 I=1,NTOT
C     WRITE(6, 14) I,UT(I)
